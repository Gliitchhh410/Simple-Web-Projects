export class QuizUI {
  ...
  handleAnswer(event) {
    ...
    if (isCorrect) {
      this.dom.scoreSpan.textContent = this.engine.score;
    }
  ...
  showResults() {
    ...
    this.dom.finalScoreSpan.textContent = this.engine.score;

    const percentage = (this.engine.score / this.engine.totalQuestions) * 100;
